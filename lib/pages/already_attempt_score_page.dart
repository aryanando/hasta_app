...
class AlreadyAttemptScorePage extends StatefulWidget {
  final Map<String, dynamic> responseData;

  const AlreadyAttemptScorePage({super.key, required this.responseData});

  @override
  State<AlreadyAttemptScorePage> createState() =>
      _AlreadyAttemptScorePageState();
}

class _AlreadyAttemptScorePageState extends State<AlreadyAttemptScorePage> {
  late int quizId;
  ...
  void initState() {
    super.initState();
    quizId = widget.responseData['attemptData']['quiz_id'];
    _fetchQuizData();
  }
  ...
  Widget build(BuildContext context) {
    final attemptData = widget.responseData['attemptData'] ?? {};
    final score = widget.responseData['score'] ?? 0;
  ...
  /// 🔹 Improved Widget to display quiz info at the top
